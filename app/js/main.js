...
app.config( function($locationProvider, $routeProvider, $firebaseRefProvider, global_config) {
     ...
     $firebaseRefProvider.registerUrl({
          ...
          usersdata: config.databaseURL + "/details", 
...
//Load controller
app.controller('MainController', ['$scope', '$firebaseRef', '$firebaseArray', '$firebaseObject', '$location', mainCtrl]);   
app.controller('HomeController', ['$scope', '$firebaseRef', '$firebaseArray', '$firebaseObject', '$location', homeCtrl]);